!(function(t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(e)
        : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).KeenSlider = e())
})(this, function() {
    'use strict'
    function t(t, e, n) {
        return (
    ...
    return (
        ...
        function(t) {
            ...
            function J(t) {
                O && S === Z(t, !0) && ft() && (e.removeAttribute(q), (O = !1), gt(), ut('dragEnd'))
            }
            function Q(t) {
            ...
            function ot() {
                $(window, 'orientationchange', Dt),
                    ...
                    $(window, 'mouseup', J),
                    $(e, 'touchstart', G, { passive: !0 }),
                    $(e, 'touchmove', B, { passive: !1 }),
                    $(e, 'touchend', J, { passive: !0 }),
                    $(e, 'touchcancel', J, { passive: !0 }),
                    $(window, 'wheel', it, { passive: !1 })
            }
            function at() {
            ...
            function jt(t, e, n, r, i) {
                pt(), (L = t), (Y = 0), (V = e), (X = n), (z = r), (H = i), (C = null), vt()
            }
            function At(n) {
                var r = a(t)
            ...
            function Tt(t) {
                ...
                if (xt() && (n !== h || t)) {
                    h = n
                    var r = y.slides
                    'number' == typeof r ? ((f = null), (o = r)) : ((f = a(r, e)), (o = f ? f.length : 0))
                    var i = y.dragSpeed
                    ;(k =
                        'function' == typeof i
                            ? i
            ...
            function Ct() {
                at(), Xt(), e && e.hasAttribute(F) && e.removeAttribute(F), ut('destroyed')
            }
            function Lt() {
                f &&
                    f.forEach(function(t, e) {
                        var n = g[e].distance * s - e * (s / l - d / l - (d / l) * (l - 1)),
                            r = ht() ? 0 : n,
                            i = ht() ? n : 0,
            ...
            function Nt() {
                ...
                for (var t = [], e = 0; e < o; e++) {
                    ...
                    t.push({ portion: a < 0 || a > 1 ? 0 : a, distance: lt() ? -1 * n + 1 - r : n })
                }
                ;(g = t), Lt(), ut('move')
            }
            function Rt(t) {
